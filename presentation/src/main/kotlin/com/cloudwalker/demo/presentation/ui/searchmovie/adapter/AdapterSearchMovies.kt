package com.cloudwalker.demo.presentation.ui.searchmovie.adapter
...
class AdapterSearchMovies(
    private var nowPlayingMovies: List<Result>,
    var clickListener: OnMovieClickListener, var onLoadMore: OnLoadMore
    ...
    var FOOTER_VIEW = 101
    var listOfMovies: ArrayList<Result>? = ArrayList(nowPlayingMovies)
    ...
    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(movie: Result, clickListener: OnMovieClickListener) {
            ...
            val imagePath = if (movie.backdropPath == null) {
                movie.posterPath
            } else {
                movie.backdropPath
            }
            Picasso.get()
                .load(Variables.imageUrl + imagePath)
